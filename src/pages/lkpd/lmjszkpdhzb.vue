...
<td colspan='23' rowspan='2' height='20' class='x27' width='1020' style='height:15.3pt;border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>路面技术状况汇总表</td>
...
<td colspan='5' class='x24' style='border-bottom:1px solid windowtext;'></td>
<td class='x25'>年</td>
<td class='x25'></td>
<td class='x25'>月</td>
<td class='x25'></td>
...
<td rowspan='2' height='54' class='x30' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;height:40.95pt;'>PQI</td>
<td colspan='7' class='x30' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>PQI分项指标评定结果</td>
<td colspan='5' class='x30' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>PQI 分布 (km)</td>
<td colspan='3' class='x30' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>PQI统计(%)</td>
 </tr>
...
<td class='x29'>次差路率</td>
 ...
 <tr v-if="hzData.length==0" height='21' style='mso-height-source:userset;height:16.05pt;' id='r7'>
     <td colspan='23'  class='x29' height='41'>暂无数据</td>
 </tr>
  ...
  <div   style="width:50%;position:relative"><Grade v-if="showGr" :data="dataArr" :lxbm="lxbm" :fx="fx" :tit="'PQI分布'"></Grade></div>
...
<script>
import hzEcharts from './pqiEcharts'
...
export default {
  ...
  methods: {
    ...
    initUser(){
     ...
     downloadExcel(){
        this.tableToExcel("mytable","路面技术状况评定汇总表");
     },
...
<td class='x29'>`+ar[i][0].PQI1+`</td>
<td class='x29'>`+ar[i][0].PCI1+`</td>
<td class='x29'>`+ar[i][0].RQI1+`</td>
<td class='x29'>`+ar[i][0].RDI1+`</td>
<td class='x29'>`+ar[i][0].PBI1+`</td>
<td class='x29'>`+ar[i][0].PWI1+`</td>
<td class='x29'>`+ar[i][0].SRI1+`</td>
<td class='x29'>`+ar[i][0].PSSI1+`</td>
...
<td class='x29'>`+ar[i][1].PQI1+`</td>
<td class='x29'>`+ar[i][1].PCI1+`</td>
<td class='x29'>`+ar[i][1].RQI1+`</td>
<td class='x29'>`+ar[i][1].RDI1+`</td>
<td class='x29'>`+ar[i][1].PBI1+`</td>
<td class='x29'>`+ar[i][1].PWI1+`</td>
<td class='x29'>`+ar[i][1].SRI1+`</td>
<td class='x29'>`+ar[i][1].PSSI1+`</td>
...
<td class='x29'>`+ar[i][2].PQI1+`</td>
<td class='x29'>`+ar[i][2].PCI1+`</td>
<td class='x29'>`+ar[i][2].RQI1+`</td>
<td class='x29'>`+ar[i][2].RDI1+`</td>
<td class='x29'>`+ar[i][2].PBI1+`</td>
<td class='x29'>`+ar[i][2].PWI1+`</td>
<td class='x29'>`+ar[i][2].SRI1+`</td>
<td class='x29'>`+ar[i][2].PSSI1+`</td>
...
this.temp=temmp
    ...
    search () {
      ...
      this.dataArr=[]
      this.loading=true
       this.$api.getHzbForLksjcxTwo( '?' + $.param(this.searchForm)).then(resp => {
        if (resp.status !== 200) {
          this.$message({
            message: '出错了',
            type: 'error'
