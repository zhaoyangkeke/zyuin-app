  ...
  <div id="lkpdlmsh" class="styleSheets" style="height: 100%"  v-loading.fullscreen.lock="fullscreenLoading">
    <div class="bill-header">
      <div class="bill-title">
        <span>抗滑性能</span>
        <ul>
         <li  class="Hight_btn"><a href="http://61.141.223.10:8002/lkpd/dcmb/getSridcList" class="el-icon-download"> 模版下载</a></li>
          <li @click="chaxBtn"><i class="el-icon-search"> 查询</i></li>
          <li @click="xzBtn"><i class="el-icon-download"> 导入</i></li>
         <!-- <li><el-upload
  class="upload-demo"
  action="http://61.141.223.10:8002/lkpd/cx/importSri"
  ...
  <span>导入</span>
      ...
      <div class="drxz bill-search" v-if="showdrxz">
           <el-form :inline="true" :model="xzForm" ref="xzForm" class="xzForm">
            ...
            <el-form-item style="margin-bottom: 0px" label="" prop="" class="">
              <el-select size="mini" clearable  class="" style="width: 80px;" placeholder="请选择方向" v-model="xzForm.fx">
    ...
    <div class="conter_table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
               ...
               :row-style="{fontFamily: 'Microsoft YaHei', fontSize: '12px'}"
                :default-sort = "{prop: 'qdzh', order: 'ascending'}"
        ...
        <el-table-column align="center" prop="lxmc" label="路线名称"  show-overflow-tooltip></el-table-column>
        ...
        <el-table-column width="150"  align="left" sortable prop="qdzh" label="起点桩号" show-overflow-tooltip>
        ...
        <el-table-column width="150"  align="left" sortable prop="zdzh" label="终点桩号" show-overflow-tooltip>
          <template scope="scope">
        ...
        <el-table-column width="100"  sortable align="left" prop="jccd" label="车道"  show-overflow-tooltip></el-table-column>
        <el-table-column width="100"  align="left" sortable prop="jcrq" label="检测日期"></el-table-column>
        <el-table-column align="left" sortable prop="jcsb" label="检测设备"></el-table-column>
        <el-table-column align="left" sortable prop="sfc" label="横向力系数(SFC)"></el-table-column>
        <el-table-column align="left" sortable prop="jlry" label="记录人员"></el-table-column>
    ...
    <el-dialog fullscreen class="data-dialog el-updata-div" :show-close="false" :close-on-click-modal="false" :visible.sync="showDetail" width="720px"  @close="resetForm">
      ...
      <khxnmb :data="lmshForm" @childByValue="childByValue"  @editOk="editOk" v-if="showDetail"></khxnmb>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  this.search(this.currentPage, this.pageSize)
    ...
    showAdd () {
      ...
      this.showxq = false
      this.isadd = true
      this.src = config.bbsrc + encodeURI('reportlet=/zsxz/lmjcSRI.cpt&op=write&dcry=管理员&bbid=10220&type=0403&lxcode=') + this.drForm.lxcode + '&szhh=' + this.drForm.szhh + '&ezhh=' + this.drForm.ezhh + '&fx=' + this.drForm.xcfx
      // this.showdrxz = false
    },
...
this.$refs.multipleTable.toggleRowSelection(row)
    ...
    search (currentPage, pageSize) {
      ...
      this.$api.getSriAllList('?pageNum=' + currentPage + '&pageSize=' + pageSize + '&' + $.param(this.searchForm)).then(resp => {
        this.loading = false
        if (resp.status !== 200) {
          this.$message({
            message: '出错了',
    ...
    download (){
      ...
      if(this.xzForm.sjlx=='千米版'){
        this.upUrl='http://61.141.223.10:8002/lkpd/drmb/importSriList'
      }else{
        this.upUrl='http://61.141.223.10:8002/lkpd/drmb/importSriBMList'
      }
      this.$refs.uploads.submit();
      // this.$api.getSriList('?' + $.param(this.xzForm)).then(resp => {
      //   this.loading = true
      //   if (resp.status !== 200) {
      //     this.$message({
      //       message: '出错了',
      ...
      //       downloadElement.download = `抗滑性能模板`; //下载后文件名
