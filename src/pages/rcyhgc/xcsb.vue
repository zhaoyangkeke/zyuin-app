  ...
  <div id="lkpdlmsh" style="height: 100%" v-loading="loading">
    ...
    <div class="conter_table">
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="djbh" label="事件单号"  show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="famc" label="事件类型" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjsx" label="车道" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjxx" label="事件说明"></el-table-column>
        <el-table-column align="center" prop="tbr" label="处置方式"></el-table-column>
        <el-table-column align="center" prop="tbsj" label="紧急度"></el-table-column>
        <el-table-column align="center" prop="tbdw" label="桩号"></el-table-column>
        <el-table-column align="center" prop="tbbm" label="巡查路线"></el-table-column>
      </el-table>
    </div>
    <footer class="footer">
