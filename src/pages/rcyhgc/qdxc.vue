  ...
  <div id="lkpdlmsh" style="height: 100%" v-loading="loading">
    ...
    <div class="conter_table">
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="djbh" label="巡查单号"  show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="famc" label="巡查路线" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjsx" label="起止桩号" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjxx" label="巡查方向"></el-table-column>
        <el-table-column align="center" prop="tbr" label="巡查开始时间"></el-table-column>
        <el-table-column align="center" prop="tbsj" label="巡查人员"></el-table-column>
        <el-table-column align="center" prop="tbdw" label="巡查车辆"></el-table-column>
        <el-table-column align="center" prop="tbbm" label="巡查类型"></el-table-column>
      </el-table>
    </div>
    <footer class="footer">
