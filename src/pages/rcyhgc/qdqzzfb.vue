  ...
  <div id="kgsqd" style="height: 100%" >
    ...
    <div class="tabArea" v-show="showDetail">
      ...
      <el-table  :data="currentMonthData" tooltip-effect="dark"
        ...
        <el-table-column align="center"  prop="zmbh" label="字目编号"   show-overflow-tooltip></el-table-column>
        <el-table-column align="center"  prop="zmbh" label="字目内容"   show-overflow-tooltip></el-table-column>
        <el-table-column align="center"  prop="zmbh" label="计量单位"   show-overflow-tooltip></el-table-column>
        <el-table-column align="center"  label="合同数量"   show-overflow-tooltip>
          <el-table-column
            prop="province"
            label="数量"
            width="100">
        ...
        <el-table-column align="center"  prop="zmbh" label="累计完成占合同%"   show-overflow-tooltip></el-table-column>
        <el-table-column align="center" label="到本期末完成"   show-overflow-tooltip>
          <el-table-column
            prop="province"
            label="数量"
            width="120">
        ...
        <el-table-column align="center" label="到上期末完成"   show-overflow-tooltip>
          <el-table-column
            prop="province"
            label="数量"
            width="120">
        ...
        <el-table-column align="center" label="本月完成"   show-overflow-tooltip>
          <el-table-column
            prop="province"
            label="数量"
            width="120">
  ...
  export default {
    ...
    data () {
      return {
        ...
        FinsdetailTit:{
          zmh:'子目编号',zmmc:'子目内容',dw:'计量单位',dj:'单价(元)',sl:'数量',je:'金额(元)'},
        stateList:[
