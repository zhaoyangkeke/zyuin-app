  ...
  <div id="gcbgl" style="height: 100%" v-loading="loading">
    <div class="header" v-show="!showDetail" >
      ...
      <div class="header_option">
        <!--<div class="jianlimb" @click="showAdd()"><span> 填写变更令</span></div>-->
        <ul>
    ...
    <div class="conter_table" v-show="!showDetail" >
      <div class="chaxun">
        <el-form :inline="true" :model="searchForm" ref="searchForm" class="searchForm">
          <el-form-item style="margin-bottom: 0px" label="" prop="" class="">
            <el-form-item class="" label="变更令编号" prop="lxbh">
              <el-input v-model="searchForm.lxcode" size="mini" placeholder="请输入变更令编号"></el-input>
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="bglbh" label="变更令编号" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" prop="bw" label="部位" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="ysjtmc" label="原设计图名称" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="yth" label="图号" show-overflow-tooltip></el-table-column>
      ...
      <div class="dialog_warp">
        <ul class="zhubnr">
          <li>
            <span>变更令编号</span>
            <p>
              <el-input size="mini" type="text" :value="lmshForm.bglbh"></el-input>
            </p>
          </li>
          <li>
            <span>工程名称</span>
            <p>
              <el-select clearable size="mini" :disabled="showxq" style="width: 100%;" v-model="htbh" value-key="htbh" placeholder="" @change="selectHt">
                <el-option v-for="item in sqbList" :key="item.htbh" :label="item.gcmc" :value="item"></el-option>
              </el-select>
            </p>
          </li>
          <li>
          ...
          <li>
            <span>原设计图名称</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.ysjtmc"></el-input>
            </p>
          </li>
          <li>
            <span>图号</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.yth"></el-input>
            </p>
          </li>
          <li>
            <span>变更设计图名称</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.bgsjtmc"></el-input>
            </p>
          </li>
          <li>
            <span>图号</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.bgth"></el-input>
            </p>
          </li>
          <li>
            <span>承包单位</span>
          ...
          <li class="text_line">
            <span>工程变更申请表编号</span>
            <p>
              <!--<el-select clearable size="mini" :disabled="showxq" style="width: 148px;" v-model="sqbbh" value-key="sqbbh" placeholder="" @change="selectSqb">
                <el-option v-for="item in sqbList" :key="item.sqbbh" :label="item.sqbbh" :value="item"></el-option>
              </el-select>-->
              <el-input class="gjzjje" size="mini" type="text" v-model="lmshForm.sqbbh"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>变更内容</span>
...
<!--    <el-dialog class="data-dialog el-updata-div" title="工程变更令" :close-on-click-modal="false" :visible.sync="showDetail" width="580px" @close="resetForm">
      <div class="dialog_warp">
        <ul class="zhubnr">
          <li>
            <span>变更令编号</span>
          ...
          <li class="text_line">
            <span>工程变更申请表编号</span>
            <p>
              &lt;!&ndash;<el-select clearable size="mini" :disabled="showxq" style="width: 148px;" v-model="sqbbh" value-key="sqbbh" placeholder="" @change="selectSqb">
                <el-option v-for="item in sqbList" :key="item.sqbbh" :label="item.sqbbh" :value="item"></el-option>
              </el-select>&ndash;&gt;
...
export default {
  ...
  methods: {
    ...
    search (currentPage, pageSize) {
      ...
      this.$api.getBglList('?pageNum=' + currentPage + '&pageSize=' + pageSize + '&' + $.param(this.searchForm)).then(resp => {
        this.loading = false
        if (resp.status !== 200) {
          this.$message({
            message: '出错了',
    ...
    addSubmit () {
      ...
      this.$api.addBglForBggl(this.lmshForm).then(res => {
        if (res.data.code === 1) {
          this.rukufile()
          this.$message({
            type: 'success',
