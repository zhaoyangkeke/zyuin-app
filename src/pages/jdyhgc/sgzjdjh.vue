  ...
  <div id="sgzjdjh" style="height: 100%" v-loading="loading">
    ...
    <div class="conter_table"  v-if="!showDetail" >
      <div class="chaxun" style="">
        <el-form :inline="true" :model="searchForm" ref="searchForm" class="searchForm">
          <el-form-item style="margin-bottom: 0px" label="" prop="" class="">
            <el-form-item class="" label="单据编号" prop="">
              <el-select size="mini"  class="" placeholder="请选择单据编号" v-model="searchForm.djbh" filterable>
                <!--<el-option v-for="(item,index) in roadOptions" :key="index" :label="item.name" :value="item.code"></el-option>-->
                <el-option v-for="(item, index) in djbharr" :key="index" :label="item.DJBH" :value="item.DJBH"></el-option>
              </el-select>
          ...
          <el-form-item style="margin-bottom: 0px" label="管理单位" prop="" class="">
            <el-select size="mini"  class="" placeholder="请选择管理单位" filterable v-model="searchForm.gldw">
              <el-option v-for="(item,index) in gldwarr" :key="index" :label="item.GLDW" :value="item.GLDW"></el-option>
            </el-select>
          </el-form-item>
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="gcmc" label="工程项目" show-overflow-tooltip></el-table-column>
      ...
      <div class="dialog_warp">
        <ul class="zhubnr"  v-if="!addzb" >
          ...
          <li>
            <span>工程名称</span>
            <p>
              <el-select clearable size="mini" :disabled="showxq" style="width: 100%;" v-model="lmshForm.gcmc" value-key="htbh" placeholder="" @change="selectHt">
          ...
          <li>
            <span>计划工期</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.jhgq"></el-input>
            </p>
          </li>
          <li>
            <span>承包单位</span>
          ...
          <li class="text_line">
            <span>子目</span>
            <p>
              <span style="margin-right: ;" v-for="(item, index) in lmshForm.mx" :key="index" v-if="item.zmmc">{{(index+1)+'、'+item.zmmc}}</span>
            </p>
          </li>
          <li class="text_line">
            <span>备注</span>
            <p>
              <el-input class="gjzjje" size="mini" type="text" v-model="lmshForm.bz"></el-input>
            </p>
          </li>
          <li>
            <span>编制人</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.bzr"></el-input>
            </p>
          </li>
          <li>
            <span>编制日期</span>
          ...
          <li>
            <span>编制部门</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.bzbm"></el-input>
            </p>
          </li>
        ...
        <ul class="zibnr" v-if="addzb">
          ...
          <li>
            <span>子目名称</span><span>开始时间</span><span>结束时间</span>
          </li>
          <li v-for="(item, index) in lmshForm.mx" :key="index">
            ...
            <p>
              ...
              <!--<el-input size="mini" type="text" v-model="item.jcnr"></el-input>-->
            </p>
            <p>
              <el-date-picker
                style="width:100%"
              ...
              <!--<el-input size="mini" type="text" v-model="item.fj"></el-input>-->
            </p>
          </li>
          <div style="clear: both"></div>
        </ul>
...
<!--
    <el-dialog class="data-dialog el-updata-div" title="施工总进度计划" :close-on-click-modal="false" :visible.sync="showDetail" width="580px" @close="resetForm">
      <div class="dialog_warp">
        <ul class="zhubnr">
          <li>
            <span>单据编号</span>
          ...
          <li>
            <span>工程名称</span>
            <p>
              <el-select clearable size="mini" :disabled="showxq" style="width: 148px;" v-model="lmshForm.gcmc" value-key="htbh" placeholder="" @change="selectHt">
                <el-option v-for="item in htList" :key="item.htbh" :label="item.gj_cgxmmc" :value="item"></el-option>
              </el-select>
            </p>
          </li>
      ...
      &lt;!&ndash;      <el-upload
            ...
            &lt;!&ndash;<i class="el-icon-edit-outline" title="添加" @click="addzibiao"></i>&ndash;&gt;
          </div>
          <li>
            <span>子目名称</span><span>开始时间</span><span>结束时间</span>
            &lt;!&ndash;<p>
          ...
          <li v-for="(item, index) in lmshForm.mx" :key="index">
            ...
            <p>
              ...
              &lt;!&ndash;<el-input size="mini" type="text" v-model="item.jcnr"></el-input>&ndash;&gt;
            </p>
            <p>
              <el-date-picker
                style="width:100%"
              ...
              &lt;!&ndash;<el-input size="mini" type="text" v-model="item.fj"></el-input>&ndash;&gt;
            </p>
          </li>
          <div style="clear: both"></div>
        </ul>
...
export default {
  ...
  methods: {
    ...
    search () {
      ...
      // }
      let {djbh, gldw, selectDate, pageNum, pageSize} = this.searchForm
      let ksrq,jsrq
    ...
    addSubmit () {
      ...
      this.$api.sgzjdjhaddSgzjdjh(this.lmshForm).then(res => {
        if (res.data.code === 1) {
          this.$message({
            type: 'success',
            message: '添加成功!'
    ...
    selectHt (value) {
      ...
      this.lmshForm.gldw = value.xmgldw
      this.lmshForm.htkgrq = value.yh_htkgrq
      this.lmshForm.htjgrq = value.yh_htwgrq
      this.lmshForm.jhgq = value.yh_htgq
  ...
  mounted () {
    this.$api.getZjHtxxRelatedAll('').then(res => {
