  ...
  <div id="lkpdlmsh" style="height: 100%" v-loading="loading">
    ...
    <div class="conter_table" v-show="!showDetail">
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="jcrq" label="检查日期" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" prop="jcxs" label="检查形式" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="gcbw" label="工程部位" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" prop="gcnr" label="工程内容" show-overflow-tooltip></el-table-column>
      ...
      <div class="dialog_warp">
        <ul class="zhubnr">
          ...
          <li>
            <span>检查形式</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.jcxs"></el-input>
            </p>
          </li>
          <li>
            <span>工程部位</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.gcbw"></el-input>
            </p>
          </li>
          <li>
            <span>管理单位</span>
          ...
          <li class="text_line">
            <span>现场检查情况</span>
            <p>
              <el-input  class="gjzjje"  size="mini" type="text" v-model="lmshForm.xcjcqk"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>是否整改</span>
            <p class="radio_line">
              <el-radio style="height: 100%;line-height: 31px" v-model="lmshForm.iszg" label="是">是</el-radio>
              <el-radio style="height: 100%;line-height: 31px" v-model="lmshForm.iszg" label="否">否</el-radio>
            </p>
          </li>
          <li class="text_line">
            <span>整改意见</span>
            <p>
              <el-input  class="gjzjje"  size="mini" type="text" v-model="lmshForm.zgyj"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>整改情况</span>
            <p>
              <el-input  class="gjzjje"  size="mini" type="text" v-model="lmshForm.zgqk"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>检查发现问题整改情况复查</span>
            <p>
              <el-input  class="gjzjje"  size="mini" type="text" v-model="lmshForm.fc"></el-input>
            </p>
          </li>
          <li>
            <span>编制单位</span>
      ...
      <div class="dialog_warp">
        <ul class="zhubnr">
          ...
          <li class="text_line">
            <span>现场检查情况</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.xcjcqk"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>是否整改</span>
          ...
          <li class="text_line">
            <span>整改意见</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.zgyj"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>整改情况</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.zgqk"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>检查发现问题整改情况复查</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.fc"></el-input>
            </p>
          </li>
          <li>
            <span>编制单位</span>
...
export default {
  ...
  methods: {
    ...
    search (currentPage, pageSize) {
      ...
      this.$api.gcxcjcgetGcxczljc('?pageNum=' + currentPage + '&pageSize=' + pageSize + '&' + $.param(this.searchForm)).then(resp => {
        this.loading = false
        if (resp.status !== 200) {
          this.$message({
            message: '出错了',
    ...
    addSubmit () {
      this.$api.gcxcjcaddGcxczljc(this.lmshForm).then(res => {
        if (res.data.code === 1) {
          this.$message({
            type: 'success',
            message: '添加成功!'
    ...
    shenhe (row, index) {
      this.$confirm('是否通过审核？', '', {
        ...
        this.$api.gcxcjcspGcxczljc('?spzt=已下发&ids=' + form.id).then(res => {
          if (res.data.code === 1) {
            this.$message({
              type: 'success',
              message: '审核通过!'
