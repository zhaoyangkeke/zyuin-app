  ...
  <div id="gcspsqs" style="height: 100%" v-loading="loading">
    <div class="header" v-show="!showDetail">
      ...
      <div class="header_option">
        <!--<div class="jianlimb" @click="showAdd()"><i class="el-icon-download"> 索赔申请书</i></div>-->
        <ul>
    ...
    <div class="conter_table" v-show="!showDetail">
      <div class="chaxun">
        <el-form :inline="true" :model="searchForm" ref="searchForm" class="searchForm">
          <el-form-item style="margin-bottom: 0px" label="" prop="" class="">
            <el-form-item class="" label="索赔申请书编号" prop="lxbh">
              <el-input v-model="searchForm.lxcode" size="mini" placeholder="请输入索赔申请书编号"></el-input>
          ...
          <el-form-item style="margin-bottom: 0px" label="承包单位" prop="" class="">
            <el-select size="mini"  class="" placeholder="请选择承包单位" v-model="searchForm.xcfx">
              ...
              <el-option label="甬台温公司工程" value="甬台温公司工程"></el-option>
            </el-select>
          </el-form-item>
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" label="状态"  show-overflow-tooltip>
          <template scope="scope">
            <span style="color:#D34C42;cursor: pointer;text-align: center" v-if="scope.row.pmmtgcspsqs_spzt==='未处理'||scope.row.pmmtgcspsqs_spzt===null" @click="shenhe(scope.row, scope.$index)">未处理</span>
            <span style="color:#00a2fd;text-align: center" v-if="scope.row.pmmtgcspsqs_spzt==='已下发'">{{scope.row.pmmtgcspsqs_spzt}}</span>
          </template>
        </el-table-column>
        <el-table-column align="center" prop="pmmtgcspsqs_djbh" label="索赔申请书编号" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="pmmtgcspsqs_sqrq" label="申请日期" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="pmmtgcspsqs_gcmc" label="工程名称" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="pmmtgcspsqs_htbh" label="合同编号" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="pmmtgcspsqs_cbdw" label="承包单位" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="pmmtgcspsqs_gldw" label="管理单位" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="pmmtgcspsqs_sqje" label="申请金额" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="pmmtgcspsqs_spje" label="审批金额" show-overflow-tooltip></el-table-column>
      </el-table>
    </div>
      ...
      <div class="dialog_warp">
        <ul class="zhubnr">
          <li>
            <span>索赔申请书编号</span>
            <p>
              <el-input size="mini" type="text" :value="lmshForm.pmmtgcspsqs_djbh"></el-input>
            </p>
          </li>
          <li>
            <span>申请日期</span>
          ...
          <li>
            <span>工程名称</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_gcmc"></el-input>
            </p>
          </li>
          <li>
            <span>合同编号</span>
            <p>
              <el-select clearable size="mini" style="width: 100%;" v-model="htbh" value-key="htbh" placeholder="" @change="selectHt">
          ...
          <li>
            <span>管理单位</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_gldw"></el-input>
            </p>
          </li>
          <li>
            <span>承包单位</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_cbdw"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>索赔事件简述</span>
            <p>
              <el-input class="gjzjje" size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_spsjjs"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>申请金额</span>
            <p>
              <el-input class="gjzjje" size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_sqje"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>附件</span>
          ...
          <li class="text_line">
            <span>审批金额</span>
            <p>
              <el-input class="gjzjje" size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_spje"></el-input>
            </p>
          </li>
          <li>
            <span>编制单位</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_dwmc"></el-input>
            </p>
          </li>
          <li>
            <span>编制日期</span>
            <p>
              <el-date-picker
                style="width:100%"
                v-model="lmshForm.pmmtgcspsqs_tbrq"
                size="mini"
                type="date"
                format="yyyy-MM-dd"
                value-format="yyyy-MM-dd"
    ...
    <!--<el-dialog class="data-dialog el-updata-div" title="索赔申请书" :close-on-click-modal="false" :visible.sync="showDetail" width="580px" @close="resetForm">
      <div class="dialog_warp">
        <ul class="zhubnr">
          <li>
            <span>索赔申请书编号</span>
          ...
          <li>
            <span>合同编号</span>
            <p>
              <el-select clearable size="mini" style="width: 148px;" v-model="htbh" value-key="htbh" placeholder="" @change="selectHt">
                <el-option v-for="item in htList" :key="item.htbh" :label="item.htbh" :value="item"></el-option>
              </el-select>
            </p>
          </li>
          ...
          <li class="text_line">
            <span>索赔事件简述</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_spsjjs"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>申请金额</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_sqje"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>附件</span>
          ...
          <li class="text_line">
            <span>审批金额</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.pmmtgcspsqs_spje"></el-input>
            </p>
          </li>
          <li>
            <span>编制单位</span>
...
export default {
  ...
  methods: {
    ...
    updateFormDia (row, index) {
      ...
      this.getfilebyid(this.lmshForm.pmmtgcspsqs_djbh)
    },
    getfilebyid (djbh) {
    ...
    search (currentPage, pageSize) {
      ...
      this.$api.bgglspsqgetSpsqdList('?pageNum=' + currentPage + '&pageSize=' + pageSize + '&' + $.param(this.searchForm)).then(resp => {
        this.loading = false
        if (resp.status !== 200) {
          this.$message({
            message: '出错了',
    ...
    addSubmit () {
      ...
      this.$api.addSpsqsForBggl(this.lmshForm).then(res => {
        if (res.data.code === 1) {
    ...
    shenhe (row, index) {
      this.$confirm('是否通过审核？', '', {
        ...
        this.$api.spSpsqsForBggl('?spzt=已下发&djbhs=' + form.pmmtgcspsqs_djbh).then(res => {
          if (res.data.code === 1) {
            this.$message({
              type: 'success',
              message: '审核通过!'
