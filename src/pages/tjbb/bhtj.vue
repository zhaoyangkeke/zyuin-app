  ...
  <div id="lkpdlmsh" style="height: 100%" v-loading="loading">
    ...
    <div class="conter_table">
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="xcrq" label="巡查日期"  show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="shlx" label="损坏类型" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="bhlx" label="病害类型" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="lxbh" label="路线编号"></el-table-column>
        <el-table-column align="center" prop="bhzh" label="病害桩号"></el-table-column>
        <el-table-column align="center" prop="xcfx" label="行车方向"></el-table-column>
        <el-table-column align="center" prop="cd" label="车道"></el-table-column>
        <el-table-column align="center" prop="bhsl" label="病害数量"></el-table-column>
        <el-table-column align="center" prop="xccz" label="现场处治"></el-table-column>
        <el-table-column align="center" prop="clwcqk" label="处理完成情况"></el-table-column>
        <el-table-column align="center" prop="sfxf" label="是否下发"></el-table-column>
      </el-table>
    </div>
    <footer class="footer">
      ...
      <div class="dialog_warp">
        <ul>
          ...
          <li>
            <span>施工单位</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.dw"></el-input>
            </p>
          </li>
          <li>
            <span>检查人</span>
          ...
          <li>
            <span>违约罚金合计</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.a"></el-input>
            </p>
          </li>
          <li class="text_line">
            <span>备注</span>
