    ...
    <div class="conter_table">
      <div class="cha_xun" style="" v-if="showSearch">
        <el-form :inline="true" :model="searchForm" ref="searchForm" class="searchForm">
          ...
          <el-form-item style="margin-bottom: 0px" label="" prop="" class="">
            <el-form-item class="" label="变更单编号" prop="lxbh">
              <el-input v-model="searchForm.lxcode" size="mini" placeholder="请输入编号"></el-input>
              <!--<selectTree class="selectTree" v-model="searchForm.bmname" :isDefaultselect="true" :urlFunc="$api.requestBmtreeAll" :dataKey="{name: 'bmname'}" placeholder="请选择部门" @treeSelect="selecttreeBm"></selectTree>-->
            </el-form-item>
          </el-form-item>
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="djbh" label="变更令编号"  show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="famc" label="变更单编号" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjsx" label="变更申请书编号" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjxx" label="变更金额"></el-table-column>
        <el-table-column align="center" prop="tbr" label="完成金额"></el-table-column>
        <el-table-column align="center" prop="tbsj" label="变更内容"></el-table-column>
      </el-table>
    </div>
    <footer class="footer">
      ...
      <div class="dialog_warp">
        <ul>
          ...
          <li>
            <span>变更申请令编号</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.sjsx"></el-input>
            </p>
          </li>
          <li>
            <span>变更金额</span>
          ...
          <li>
            <span>变更内容</span>
            <p>
              <el-input size="mini" type="text" v-model="lmshForm.tbsj"></el-input>
            </p>
          </li>
