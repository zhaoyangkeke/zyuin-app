  ...
  <div id="lkpdlmsh" style="height: 100%" v-loading="loading">
    ...
    <div class="conter_table">
      <div class="cha_xun" style="" v-if="showSearch">
        <el-form :inline="true" :model="searchForm" ref="searchForm" class="searchForm">
          <el-form-item style="margin-bottom: 0px" label="" prop="" class="">
            <el-form-item class="" label="年份" prop="lxbh">
              <el-input v-model="searchForm.lxcode" size="mini" placeholder="请输入年份"></el-input>
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="nd" label="年度"  show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="je1" label="年度养护计划投资" show-overflow-tooltip>
          <el-table-column align="center" prop="je2" label="养护费用预算"  show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="je3" label="房建维修费用预算" show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="je4" label="机电系统维护费用预算"  show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="je5" label="应急预备费" show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="je6" label="投资类费用预算"  show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="hj" label="总计" show-overflow-tooltip></el-table-column>
        </el-table-column>
        <el-table-column align="center" prop="sjhj" label="年度实际安排投资" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="ce" label="差额"></el-table-column>
      </el-table>
    </div>
    <footer class="footer">
