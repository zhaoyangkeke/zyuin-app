  ...
  <div id="lkpdlmsh" style="height: 100%" v-loading="loading">
    ...
    <div class="conter_table">
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="famc" label="项目名称" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjsx" label="施工单位" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjxx" label="监理单位"></el-table-column>
        <el-table-column align="center" prop="tbr" label="起止桩号"></el-table-column>
        <el-table-column align="center" prop="tbsj" label="时间开工"></el-table-column>
        <el-table-column align="center" prop="gcfl" label="工程分类"></el-table-column>
        <el-table-column align="center" prop="xmzt" label="项目状态"></el-table-column>
