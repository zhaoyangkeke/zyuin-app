  ...
  <div id="lkpdlmsh" style="height: 100%" v-loading="loading">
    ...
    <div class="conter_table">
      <div class="cha_xun" style="" v-if="showSearch">
        <el-form :inline="true" :model="searchForm" ref="searchForm" class="searchForm">
          <el-form-item style="margin-bottom: 0px" label="" prop="" class="">
            <el-form-item class="" label="单位" prop="lxbh">
              <el-input v-model="searchForm.lxcode" size="mini" placeholder="请输入单位"></el-input>
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column align="center" prop="djbh" label="单位名称"  show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="famc" label="年度养护结算费用(万元)" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjsx" label="路线长度(km)" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="sjxx" label="收费站数量"></el-table-column>
        <el-table-column align="center" prop="tbr" label="断面年均日流量(辆)"></el-table-column>
        <el-table-column align="center" prop="tbsj" label="隧道(m)"></el-table-column>
        <el-table-column align="center" prop="tbdw" label="桥梁(m)"></el-table-column>
        <el-table-column align="center" prop="tbbm" label="年均路面投入(万元/km)"></el-table-column>
      </el-table>
    </div>
    <footer class="footer">
